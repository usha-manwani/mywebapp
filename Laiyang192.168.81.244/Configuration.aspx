<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true"
    CodeBehind="Configuration.aspx.cs" Inherits="WebCresij.Configuration" %>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <cc1:TabContainer ID="tb1" runat="server" CssClass="fancy fancy-green ">
                        ...
                        <ContentTemplate>
                            <fieldset class="group" style="width: 80%; font-size: small">
                                ...
                                <div class="row" style="padding-right: 10px;">
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-sm-12 col-md-12">
                                        <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                            <legend style="width: auto" align="center"><span>
                                                <%=Resources.Resource.IO%></span></legend>
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6" style="font-size: x-small;">
                                                    <ul class="checkbox">
                                                        <li>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6" style="font-size: x-small">
                                                    <ul class="checkbox">
                                                        ...
                                                        <li>
                                                            <input type="checkbox" id="cb53" name="sys"
                                                                value="xcheese" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col" style="text-align: center">
                                        <button class="btn-info customButton" id="writeConfig"
                                            value="Write Configuration">
                                            <span><%=Resources.Resource.WriteConfig%></span></button>
                                    </div>
                                </div>
                            </fieldset>
                        </ContentTemplate>
                            ...
                            <div class="row" style="margin-right: 5px;">
                                <div class="col-lg-6 ">
                                    <div class="row" style="padding-bottom: 30px">
                                        <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                            <legend align="center" style="width: auto"><span>
                                                <%=Resources.Resource.Options%></span></legend>
                                    ...
                                    <div class="row" style="padding-bottom: 30px">
                                        <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                            <legend align="center" style="width: auto"><span>
                                                <%=Resources.Resource.Data%></span></legend>
                                            <div style="min-width: 300px;"></div>
                                        </fieldset>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                        <legend align="center" style="width: auto"><span>
                                            <%=Resources.Resource.SettingsMenu%></span></legend>
                                        <div style="margin-left: 5px; margin-right: 5px; font-size: small">
                                            <label for="baud">
                                                <span><%=Resources.Resource.BaudRate%></span>
                                            </label>&nbsp;
                                        ...
                                        <div>
                                            <asp:Label runat="server" Text="<%$Resources:Resource, HexCode %>">
                                            </asp:Label>
                                        </div>
                                        <div class="row" style="margin-left: 5px; margin-right: 5px; font-size: small">
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                                <label for="tb1">
                                                    <span><%=Resources.Resource.ProjOn%></span>
                                                </label>&nbsp;
                                            </div>
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                        ...
                                        <div class="row" style="margin-left: 5px; margin-right: 5px; font-size: small">
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                                <label for="tb2">
                                                    <span><%=Resources.Resource.ProjOff%></span>
                                                </label>&nbsp;
                                            </div>
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                                <input type="text" class="form-control" />
                                        ...
                                        <div class="row" style="margin-left: 5px; margin-right: 5px; font-size: small">
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                                <label for="tb3">
                                                    <span><%=Resources.Resource.Video%></span>
                                                </label>
                                                &nbsp;
                                            </div>
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                        ...
                                        <div class="row" style="margin-left: 5px; margin-right: 5px; font-size: small">
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                                <label for="tb6">
                                                    <span><%=Resources.Resource.Sleep%></span>
                                                </label>&nbsp;
                                            </div>
                                            <div class="col" style="margin-left: 5px; margin-right: 15px; font-size: small">
                                                <input type="text" class="form-control" />
                                        ...
                                        <div class="row" style="text-align: center; padding-bottom: 30px">
                                            ...
                                            <div class="col">
                                                <button id="projcancle" class="btn btn-group border-dark"
                                                    value="Cancel">
                    ...
                    <cc1:TabPanel runat="server">
                        ...
                        <ContentTemplate>
                            <div class="row" style="margin-right: 5px;">
                                <div class="col-lg-6">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                        <legend align="center" style="width: auto" runat="server">
                                            <span><%=Resources.Resource.Light%></span>1</legend>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6" style="font-size: small">
                                                <ul class="checkbox">
                                                    <li>
                                                        ...
                                                        <label for="bc1">
                                                            <span><%=Resources.Resource.Light%>

                                                            </span>1 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc2" name="light1" value="pepperoni" />
                                                        <label for="bc2">
                                                            <span><%=Resources.Resource.Light%>

                                                            </span>2 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc3" name="light1" value="pepperoni" />
                                                        <label for="bc3">
                                                            <span><%=Resources.Resource.Light%>

                                                            </span>3 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc4" name="light1" value="pepperoni" />
                                                        <label for="bc4">
                                                            <span><%=Resources.Resource.Light%>

                                                            </span>4 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc5" name="light1" value="pepperoni" />
                                                        <label for="bc5">
                                                            <span><%=Resources.Resource.Light%>

                                                            </span>5 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc6" name="light1" value="pepperoni" />
                                                        <label for="bc6">
                                                            <span><%=Resources.Resource.Light%>

                                                            </span>6<span><%=Resources.Resource.AutoOn%></span></label></li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6" style="font-size: small">
                                                <ul class="checkbox">
                                                    <li>
                                                        ...
                                                        <label for="bc7">
                                                            <span><%=Resources.Resource.Light%>
                                                            </span>1 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc8" name="light1" value="pepperoni" />
                                                        <label for="bc8">
                                                            <span><%=Resources.Resource.Light%>
                                                            </span>2 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc9" name="light1" value="pepperoni" />
                                                        <label for="bc9">
                                                            <span><%=Resources.Resource.Light%>
                                                            </span>3 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc10" name="light1" value="pepperoni" />
                                                        <label for="bc10">
                                                            <span><%=Resources.Resource.Light%>
                                                            </span>4 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc11" name="light1" value="pepperoni" />
                                                        <label for="bc11">
                                                            <span><%=Resources.Resource.Light%>
                                                            </span>5 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc12" name="light1" value="pepperoni" />
                                                        <label for="bc12">
                                                            <span><%=Resources.Resource.Light%>
                                                            </span>6 <span><%=Resources.Resource.AutoOff%>
                                                            </span>
                                                        </label>
                                                    </li>
                                                </ul>
                                ...
                                <div class="col-lg-6">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                        <legend align="center" style="width: auto"><span>
                                            <%=Resources.Resource.Light%></span> 2</legend>
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6" style="font-size: small">
                                                <ul class="checkbox">
                                                    <li>
                                                        ...
                                                        <label for="bc13">
                                                            <%=Resources.Resource.Light%></span>
                                                            7 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc14" name="light2" value="pepperoni" />
                                                        <label for="bc14">
                                                            <%=Resources.Resource.Light%></span>
                                                            8 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc15" name="light2" value="pepperoni" />
                                                        <label for="bc15">
                                                            <%=Resources.Resource.Light%></span>
                                                            9 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc16" name="light2" value="pepperoni" />
                                                        <label for="bc16">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 10 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc17" name="light2" value="pepperoni" />
                                                        <label for="bc17">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 11 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc18" name="light2" value="pepperoni" />
                                                        <label for="bc18">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 12 <span><%=Resources.Resource.AutoOn%></span></label></li>
                                                </ul>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6" style="font-size: small">
                                                <ul class="checkbox">
                                                    <li>
                                                        ...
                                                        <label for="bc19">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 7 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc20" name="light2" value="pepperoni" />
                                                        <label for="bc20">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 8 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc21" name="light2" value="pepperoni" />
                                                        <label for="bc21">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 9 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc22" name="light2" value="pepperoni" />
                                                        <label for="bc22">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 10 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc23" name="light2" value="pepperoni" />
                                                        <label for="bc23">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 11 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                    <li>
                                                        <input type="checkbox" id="bc24" name="light2" value="pepperoni" />
                                                        <label for="bc24">
                                                            <%=Resources.Resource.Light%>
                                                            </span> 12 <span><%=Resources.Resource.AutoOff%></span></label></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </fieldset>
                            ...
                            <div class="row" style="margin-right: 5px;">
                                <div class="col-lg-3 col-md-6 col-sm-12" style="font-size: small">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                        <legend style="width: auto" align="center"><span>
                                            <%=Resources.Resource.Curtain%></span> 1</legend>
                                        <ul class="checkbox">
                                            <li>
                                                <input type="checkbox" id="w1" name="w1" value="pepperoni" />
                                                <label for="w1">
                                                    <%=Resources.Resource.Curtain%> 
                                                    1 <%=Resources.Resource.AutoOn%></label></li>
                                            <li>
                                                <input type="checkbox" id="w11" name="w1" value="pepperoni" />
                                                <label for="w11">
                                                    <%=Resources.Resource.Curtain%> 
                                                    1 <%=Resources.Resource.AutoOff%></label></li>
                                        </ul>
                                    </fieldset>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12" style="font-size: small">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                        ...
                                        <ul class="checkbox">
                                            <li>
                                                ...
                                                <label for="w2">
                                                    <%=Resources.Resource.Curtain%> 
                                                    2 <%=Resources.Resource.AutoOn%></label></li>
                                            <li>
                                                <input type="checkbox" id="w22" name="w2" value="pepperoni" />
                                                <label for="w22">
                                                    <%=Resources.Resource.Curtain%> 
                                                    2 <%=Resources.Resource.AutoOff%></label></li>
                                        </ul>
                                    </fieldset>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12" style="font-size: small">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                        ...
                                        <ul class="checkbox">
                                            <li>
                                                ...
                                                <label for="w3">
                                                    <%=Resources.Resource.Curtain%> 
                                                    3 <%=Resources.Resource.AutoOn%></label></li>
                                            <li>
                                                <input type="checkbox" id="w33" name="w33" value="pepperoni" />
                                                <label for="w33">
                                                    <%=Resources.Resource.Curtain%> 
                                                    3 <%=Resources.Resource.AutoOff%></label></li>
                                        </ul>
                                    </fieldset>
                                </div>
                                <div class="col-lg-3 col-md-6 col-sm-12" style="font-size: small">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999;">
                                        ...
                                        <ul class="checkbox">
                                            <li>
                                                ...
                                                <label for="w4">
                                                    <%=Resources.Resource.Curtain%> 
                                                    4 <%=Resources.Resource.AutoOn%></label></li>
                                            <li>
                                                <input type="checkbox" id="w44" name="w4" value="pepperoni" />
                                                <label for="w44">
                                                    <%=Resources.Resource.Curtain%> 
                                                    4 <%=Resources.Resource.AutoOff%></label></li>
                                        </ul>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="row" style="width: 80%;">
                                <div class="col">
                                    <fieldset class="group" style="box-shadow: 0 0 10px #999; width: 100%;">
                                        ...
                                        <label for="sys2" style="margin-left: 10px; margin-top: 10px">
                    ...
                    <cc1:TabPanel runat="server">
                        <HeaderTemplate>
                            <span>
                                <i class="fa fa-laptop" style="padding-right: 4px; width: 15px; color: black"></i>
                                Config</span>
                        </HeaderTemplate>
                        <ContentTemplate>
                            <div>
                                <div id="macAddress">
                                    ...
                                    <%-- <table class="macaddresstable">
                                        <tr class="trrow">
                                            <td style="width: 40%!important">
                                                <label>ClassName </label>
                                                <input type="hidden" name="ip" class="hiddenip" value="172.168.11.114" />
                                            </td>
                                            <td>
                                                <span style="float: left">
                                                    <input type="text" class="form-control column"/></span>
                                            ...
                                            <td>
                                                <span >
                                                    <img src="Images/done.png" height="25" width="25" class="tick" 
                                                        style="display:none"/>
                                                    <img src="Images/notdone.png" height="25" width="25" class="nottick" 
                                        ...
                                        <tr class="trrow">
                                            <td style="width: 40%">
                                                ...
                                                <input type="hidden" name="ip" class="hiddenip" value="172.168.11.113" />
                                            </td>
                                            <td>
                                                <span style="float: left">
                                                    <input type="text" class="form-control column" /></span>
                                    ...
                                    <table class="macaddresstable">
                                        <tr class="trrow">
                                            <td style="width: 40%">
                                                ...
                                                <input type="hidden" name="ip" class="hiddenip" value="172.168.11.111" />
                                            </td>
                                            <td >
                                                <span style="float: left">
                                                    <input type="text" class="form-control column" /></span>
                                        ...
                                        <tr class="trrow">
                                            <td style="width: 40%">
                                                <label>ClassName fourth</label>
                                                <input type="hidden" name="ip" class="hiddenip" value="172.168.11.112" />
                                            </td>
                                            <td >
                                                <span style="float: left">
                                                    <input type="text" class="form-control column" /></span>
                                ...
                                <div>
                                    <button class="btn-info customButton" value="okmac"
                                        onclick="changeMac(); return false;">
                                        ok</button>
                                    <button class="btn-info customButton" value="cancelmac">Cancel</button>
                                </div>
                            </div>
                        </ContentTemplate>
                    </cc1:TabPanel>
