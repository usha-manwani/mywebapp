...
$(document).ready(function GetOrgData() {
    ...
    $.ajax({
        type: "POST",
        url: "../Services/getOrganisationData.asmx/GetTeacherData",
        //data: jsonData,
...
function FillOrgData(idata) {
    ...
    for (i = 0; i < col1.length; i++) {
        ...
        column9.innerHTML = '<a class="JURL jbtn_xs hover_blue show_jmodal" j-page-href="window/alert/data/Edit_Teacher.html?index='+col1[i]+ '" j-page-box="#jcontent"><i class="fa fa-pencil"></i></a>' +            
            '<a class="JURL jbtn_xs hover_red show_jmodal" j-page-href="window/alert/DeleteTeacher.html?index=' + col1[i] +'" j-page-box="#jcontent"><i class="fa fa-trash"></i></a>';

        $("#teachertable").find('tbody').append($(row1));
    }
