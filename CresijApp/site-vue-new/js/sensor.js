  ...
  $(self).load(url, function() {
    ...
    $(self)
      ...
      .each(function(_, element) {
        $(self).append(
          '<script src="' + $(element).attr("href") + '"></script>'
        );
      });
    $(self)
      .find("link[as='style']")
      .each(function(_, element) {
        $(self).append(
          '<link rel="stylesheet" href="' + $(element).attr("href") + '">'
        );
      });
    if (cb) {
      try {
...
$.initSelectBox = function(cfg) {
  ...
  for (var i = 0; i < cfg.data.length; i++) {
    inner +=
      '<div class="option"><input type="radio" name="' +
      cfg.name +
      '" value="' +
      cfg.data[i].value +
      '"><label for="">' +
  ...
  if (cfg.data[0]) {
    ...
    $("#" + cfg.name).data("data-value", {
      value: cfg.data[0].value,
      name: cfg.data[0].label,
    });
  }
};
...
$(document).ready(function() {
  ...
  $("body").on("click", ".JURL", function() {
    ...
    if (typeof pannelurl == "string") {
      ...
      if (pannelurl.includes("assist.html")) {
        ...
        if (divpart.length > 0) $("#assistdivnumber").attr("value", divpart);
  ...
  $("body").on("click", ".JPAGE", function() {
    ...
    $(this)
      .parents(".jpager")
      .trigger("page-change", $(this).index());
  });
  ...
  $("body").on("click", ".jdropdown2", function() {
    ...
    $(this)
      ...
      .click(function() {
        ...
        $(this)
          .parents(".jdropdown2")
          .children(".jdropdown2-box")
          .html(select_option);
        $(this)
          .parents(".jdropdown2-list")
          .fadeOut("fast");
      });
  });
  ...
  $("body").on("click", ".j-active-control-btn", function() {
    $(this)
      .parents(".j-active-control")
      .children(".j-active-control-btn")
      .removeClass("active");
    $(this).addClass("active");
  });
  ...
  $("body").on("click", ".L-CTRL-01", function() {
    if ($(this).hasClass("fa-minus-square")) {
      ...
      $(this)
        .parents(".left-menu-building")
        .next(".left-menu-building-dropbox")
        .css("display", "none");
    } else {
  ...
  $("body").on("click", ".check-building", function() {
    if (
      $(this)
        .parents(".left-menu-building")
        .hasClass("building-unchecked")
    ) {
      $(this)
        .parents(".left-menu-building")
        .removeClass("building-unchecked");
      $(this)
        .parents(".left-menu-building")
        .addClass("building-checked");
      $(this)
        .parents(".left-menu-building")
        .next(".left-menu-building-dropbox")
        .find("input[type='checkbox']")
      ...
      $(this)
        ...
        .find(".check-level")
        .parents(".left-menu-level")
        .removeClass("level-unchecked");
      $(this)
        .parents(".left-menu-building")
        .next(".left-menu-building-dropbox")
        .find(".check-level")
        .parents(".left-menu-level")
        .addClass("level-checked");
    } else {
      $(this)
        .parents(".left-menu-building")
        .removeClass("building-checked");
      $(this)
        .parents(".left-menu-building")
        .addClass("building-unchecked");
      $(this)
        .parents(".left-menu-building")
        .next(".left-menu-building-dropbox")
        .find("input[type='checkbox']")
      ...
      $(this)
        ...
        .find(".check-level")
        .parents(".left-menu-level")
        .removeClass("level-checked");
      $(this)
        .parents(".left-menu-building")
        .next(".left-menu-building-dropbox")
        .find(".check-level")
        .parents(".left-menu-level")
        .addClass("level-unchecked");
    }
  });
  // ----全选楼层
