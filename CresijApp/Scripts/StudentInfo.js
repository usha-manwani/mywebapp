...
$(function GetOrgData() {
    ...
    $.ajax({
        type: "POST",
        url: "../Services/getOrganisationData.asmx/GetStudentData",
        //data: jsonData,
...
function FillOrgData(idata) {
    ...
    for (i = 0; i < col1.length; i++) {
        ...
        column1.classList = "text-left pl-3";
        column1.innerText = col1[i];
        var column2 = row1.insertCell(2);
        column2.classList = "text-left pl-3";
        ...
        column4.classList = "text-left pl-3";
        ...
        column9.innerHTML = '<a class="JURL jbtn_xs hover_blue show_jmodal" j-page-href="window/alert/data/Edit_Student.html?index='+col1[i]+'" j-page-box="#jcontent"><i class="fa fa-pencil"></i></a>' +
            '<a class="JURL jbtn_xs hover_red show_jmodal" j-page-href="window/alert/DeleteStudent.html?index=' + col1[i] +'" j-page-box="#jcontent"><i class="fa fa-trash"></i></a>';

        $("#studenttable").find('tbody').append($(row1));
    }
