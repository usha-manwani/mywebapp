      ...
      <asp:UpdatePanel runat="server">
        ...
        <div class="container-fluid " id="tempdata" >
            ...
            <div class="animated fadeIn">
                  <!-- Widgets  -->
                <div class="row" >
                 <div class="col-sm-6 col-lg-3" title="Temperature" >
                        <div class="card bg-flat-color-1" style="background-color:#ab8ce4">
                            <div class="card-body">
                                ...
                                <div class="card-right float-right text-right">
                                    <i class="wi wi-thermometer" style="font-size:2.5em; color:#d5c5f1"></i>
                                </div><!-- /.card-right -->
                    ...
                    <div class="col-sm-6 col-lg-3" title="Humidity" >
                        <div class="card  bg-flat-color-6" style="background-color:#00c292">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left" >
                                    <h3>Humidity</h3>
                                    <h3 class="mb-0 fw-r">
                                ...
                                <div class="card-right float-right text-right">
                                    <i class="wi wi-humidity" style="font-size:2.5em; color:#7fe0c8"></i>
                                </div><!-- /.card-right -->
                    ...
                    <div class="col-sm-6 col-lg-3" title="PM2.5(µg/m3)" >
                        <div class="card  bg-flat-color-3" style="background-color:#fb9678">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3> PM2.5(µg/m3)</h3>
                                    <h3 class="mb-0 ">
                                ...
                                <div class="card-right float-right text-right">
                                    <i class="wi wi-humidity" style="font-size:2.5em; color:#fdcabb"></i>
                                </div><!-- /.card-right -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3" title="PM10(µg/m3)" >
                        <div class="card  bg-flat-color-2" style="background-color:#85c988">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3>PM10(µg/m3)</h3>
                                    <h3 class="mb-0 ">
                                ...
                                <div class="card-right float-right text-right">
                                    <i class="wi wi-humidity" style="font-size:2.5em; color:#c2e4c3"></i>
                                </div><!-- /.card-right -->
