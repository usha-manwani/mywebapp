<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" 
    CodeBehind="Options.aspx.cs" Inherits="WebCresij.Options" %>
                        ...
                        <cc1:TabPanel runat="server" ID="deletepaneltab" BorderStyle="None">
                            ...
                            <ContentTemplate>
                                <asp:TreeView ID="TreeViewDelete" ToolTip="Delete Details" runat="server"
                                    OnSelectedNodeChanged="TreeViewDelete_SelectedNodeChanged" 
                                    NodeStyle-NodeSpacing="5px" CssClass="leftspace" ForeColor="#2F323A">
                                </asp:TreeView>
                            </ContentTemplate>
                        </cc1:TabPanel>
                ...
                <div style="position: center;">
                        ...
                        <div class="modal-content">
                            ...
                            <div>
                                ...
                                <div class="row" style="width: 50%; float: left; margin-right: 30px;">
                                    <div class="col">
                                        <asp:Button ID="Button3" Text="<%$Resources:Resource, Save %>" runat="server" 
                                            OnClientClick="hideGrade();" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group row margintop">
                                            <asp:Label runat="server" Font-Bold="true" AssociatedControlID="ddlInstitute"
                                                CssClass="col-md-5 labelpadding" 
                                                Text="<%$Resources:Resource, SelectInstitute %>"></asp:Label>
                                            <div class="col-md-7">
                                                <asp:DropDownList Width="100px" AutoPostBack="false"
                                                    ...
                                                    onChange="GetMachineCounts(this);return false;">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="form-group row margintop">
                                            <asp:Label runat="server" Font-Bold="true" AssociatedControlID="projtb"
                                                CssClass="col-md-5 labelpadding" 
                                                Text="<%$Resources:Resource, NoOfProjector %>"></asp:Label>
                                            <div class="col-md-7">
                                ...
                                <div class="row" style="width: 50%; float: left; margin-right: 30px;">
                                    <asp:Button ID="Button2" Text="<%$Resources:Resource, Save %>" runat="server"
                                        OnClientClick="saveandhideDevices();" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="form-group">
                                <div style="width: 30%; float: left">
                                    <asp:Label runat="server" Font-Bold="true" AssociatedControlID="txtIns"
                                        CssClass="col-lg-3 control-label" Text="<%$Resources:Resource, InsName %>"></asp:Label>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="row" style="width: 50%; margin-top: 50px; float: left; margin-right: 30px;">
                                    ...
                                    <div class="col">
                                        <asp:Button ID="saveg" Text="<%$Resources:Resource, Save %>"
                                ...
                                <div class="row" style="width: 50%; float: left; margin-right: 30px;">
                                    <div class="col">
                                        <asp:Button ID="btnaddgrade" Text="<%$Resources:Resource, Add %>" runat="server"
                                            OnClientClick="AddTextGrade(); return false;" />
                                    </div>
                                    <div class="col">
                                        <asp:Button ID="save" Text="<%$Resources:Resource, Save %>" runat="server"
                                            OnClientClick="hideGrade();"
                                            OnClick="btnGradesave_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="row ">
                                ...
                                <div id="TextContainer" class="form-horizontal" style="width: 90%">
                                    <div class="form-group row margintop">
                                        <asp:Label runat="server" Text="<%$Resources:Resource, ClassName %>"
                                            AssociatedControlID="Class_Name"
                            ...
                            <div class="row margintop" style="width: 50%; float: left; margin-right: 30px;">
                                <div class="col">
                                    <asp:Button ID="BtnClass" Text="<%$Resources:Resource, Add %>" runat="server"
                                        OnClientClick="AddTextClass(); return false;" />
                                </div>
                                <div class="col">
                                    <asp:Button ID="BtnClassSave" Text="<%$Resources:Resource, Save %>" runat="server"
                                        OnClientClick="hideClass();" OnClick="BtnClassSave_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="row" style="float: left;">
                                ...
                                <div class="form-group row margintop" style="width: 90%">
                                    <asp:Label Text="<%$Resources:Resource, CCIP %>" AssociatedControlID="ccSystem"
                                        runat="server" CssClass="col-md-5 control-label" Font-Bold="True"></asp:Label>
                                    <div class="col-md-7">
                            ...
                            <div class="row" style="width: 50%; float: left; margin-right: 30px;">
                                <div class="col">
                                    <asp:Button ID="btncam" Text="<%$Resources:Resource, AddCam %>" runat="server"
                                        OnClientClick="AddTextCam(); return false;" />
                                </div>
                                <div class="col">
                                    <asp:Button ID="BtnCamSave" Text="<%$Resources:Resource, Save %>" runat="server"
                    ...
                    <div id="edit" class="modal">
                        <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <asp:Label runat="server" Text="<%$Resources:Resource, CamIP %>" 
                                        CssClass="control-label" AssociatedControlID="camEditIP"></asp:Label>
                                    <div>
                                        <asp:TextBox runat="server" ID="camEditIP" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:Label runat="server" Text="<%$Resources:Resource, PortNo %>" 
                                        CssClass=" control-label" AssociatedControlID="portEdit"></asp:Label>
                                    <div>
                                        <asp:TextBox runat="server" ID="portEdit" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:Label runat="server" Text="ID" CssClass="control-label" 
                                        AssociatedControlID="idEditcam"></asp:Label>
                                    <div class="">
                                        <asp:TextBox runat="server" ID="idEditcam" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <asp:Label runat="server" Text="<%$Resources:Resource, Password %>" 
                                        CssClass=" control-label" AssociatedControlID="passEditcam"></asp:Label>
                                    <div>
                            ...
                            <div class="row" style="width: 50%; margin-top: 50px; float: left; margin-right: 30px;">
                                <div class="col">
                                    <asp:Button ID="cancelCamEdit" Text="<%$Resources:Resource, Cancel %>"
                                        runat="server" OnClientClick="hideEdit(); return false;" />
                                </div>
                                <div class="col">
                                    <asp:Button ID="saveCamEdit" Text="<%$Resources:Resource, Save %>" 
                                        runat="server" OnClick="saveCamEdit_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="DivRename" class="modal">
                        ...
                        <div class="modal-content" style="width: 500px; height: 400px; text-align: center;">
                            ...
                            <div class="row " style="padding-left: 20px; padding-top: 40px;">
                                <asp:Label runat="server" Text="<%$Resources:Resource, NewName %>"
                                    AssociatedControlID="tbRename"></asp:Label>&nbsp;                   
                                <asp:TextBox ID="tbRename" runat="server" CssClass="form-control">
                                    </asp:TextBox>
                                <br />
                            </div>
                            <div class="row">
                                <div class="col">
                                    <asp:Button ID="saveRename" runat="server" Text="<%$Resources:Resource, Save %>"
                                        OnClick="saveRename_Click" />
                                </div>
                                <div class="col">
                    ...
                    <div id="DivEditMachineIP" class="modal">
                        ...
                        <div class="modal-content" style="width: 500px; height: 400px; text-align: center;">
                            ...
                            <div class="row " style="padding-left: 20px; padding-top: 40px;">
                                <asp:Label runat="server" Text="<%$Resources:Resource, IPAddress %>"
                                    AssociatedControlID="tbRename"></asp:Label>
                                &nbsp;                   
                            ...
                            <div class="row">
                                <div class="col">
                                    <asp:Button ID="Saveeditip" runat="server" Text="<%$Resources:Resource, Save %>"
                                        OnClick="Saveeditip_Click" />
                                </div>
                                <div class="col">
                    ...
                    <div id="edithours" class="modal scroll">
                        <div class="modal-content">
                            ...
                            <div>
                                <p id="workingHourslocation" runat="server">
                                    <span>
                                ...
                                <div class="row" style="width: 50%; float: left; margin-right: 30px;">
                                    <asp:Button ID="Button4" Text="<%$Resources:Resource, Save %>" runat="server"
                                        OnClientClick="saveandhideworkinghour();" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="del" class="modal">
                        <div class="modal-content" style="width: 350px; min-height: 150px">
                            ...
                            <div class="row">
                                <div style="width: 50%">
                                    <asp:Button ID="btndel" runat="server" Text="<%$Resources:Resource, YesDelete %>"
                                        OnClick="Btndel_Click" />
                                </div>
                                <div style="width: 50%">
                                    <asp:Button ID="delcancel" runat="server" Text="<%$Resources:Resource, Cancel %>"
                                        OnClientClick="hideDelConfirm(); return false;" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="delnot" class="modal">
                        <div class="modal-content" style="width: 250px">
                            ...
                            <%--<div class="row ">--%>
                                ...
                                <br />
                                <asp:Button ID="Button1" runat="server" Text="Ok, got it!"
                                    OnClientClick="hideDelNot(); return false;" />
                            </div>
                        </div>
                    </div>
                </div>
...
function GetDynamicTextClass(value) {
    return '<div class="form-group row  margintop">' + '<asp:Label runat="server" Text="<%$Resources:Resource, Class %>" CssClass="col-md-5 control-label labelpadding" Font-Bold="True"/>' +
        ...
        '<div class="form-group row  margintop">' + '<asp:Label runat="server" Text="<%$Resources:Resource, ccip %>" CssClass="col-md-5 control-label labelpadding" Font-Bold="True"/>' +
