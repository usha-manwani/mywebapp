...
<asp:Content ID="Main" ContentPlaceHolderID="masterchildBody" runat="server">    
    ...
    <script src="Scripts/MessagesToClient.js?v=6" type="text/javascript"></script>
    <div class="row" style="padding-right: 15px; ">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table style="width: 100%; margin-top:-40px;" >
                    <tr class="site-footer" style="height: 50px;">
                        <td style="text-align: left; background-color: #4ecdc4;">&nbsp;
                            <span><%=Resources.Resource.Status%></span>:</td>
                    ...
                    <tr>
                        <td style="width: 100%">
                            <br />
                            <label for="ddlins" style="color:white">&nbsp;<span>
                    ...
                    <tr>
                        <td colspan="2" style="width: 90%; min-width:400px">
                            <asp:GridView ID="GridView1" runat="server" Font-Size="Small" ViewStateMode="Enabled"
                                EmptyDataRowStyle-BackColor="Black" AllowPaging="true" PageSize="12"
                                 OnPageIndexChanging="GridView1_PageIndexChanging" PagerSettings-Mode="Numeric"
                                ...
                                <RowStyle BackColor="WhiteSmoke" ForeColor="black" Height="38" />
                                <AlternatingRowStyle BackColor="White" ForeColor="black" Height="38" />
                                <Columns>
