<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="final.home"  MasterPageFile="~/Site.Master" %>
...
<asp:Content ContentPlaceHolderID="MainContent" ID="MainBody" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" GridLines="Horizontal" AutoGenerateColumns="false" 
        ...
        <RowStyle Height="30"  />
        <Columns>
            <asp:BoundField DataField="Camera_IP" HeaderText="Camera IP" HeaderStyle-HorizontalAlign="Left"  />
