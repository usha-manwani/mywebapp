...
<asp:Content ID="Content2" ContentPlaceHolderID="childmastercontent" runat="server">
    ...
    <div class="divopt">
        <h3 style="text-align:center"><span><%=Resources.Resource.AuthorizeUser%></span></h3>
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <div id="roleModal" class="modal" style="display: none; max-width: 500px; min-height: 800px; position:center; color:lightslategray!important">
                ...
                <div>
                    <br />
                    <h3 style="text-align:center"><span><%=Resources.Resource.SingleRequestToApprove%></span></h3>
                <hr />
