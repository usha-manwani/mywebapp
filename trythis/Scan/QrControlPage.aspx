...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="max-width:600px; text-align:center">
        <div class="col-12">
        <div class="clearfix"></div>
        <div class=" noborder padding-top">
            <input type="hidden" id="lockstatus" value="lock"/>
            ...
            <fieldset class="fieldSetControl">
                <legend align="center" style="width: auto; font-size: 16px;">&nbsp;
                    <%=Resources.Resource.ProjectorAndPC%>&nbsp;</legend>
                <div class="row">
            ...
            <fieldset class="fieldSetControl" id="volfieldset" style=" align-content: center">
    ...
    <script src="QrControl.js?version=8"></script>
