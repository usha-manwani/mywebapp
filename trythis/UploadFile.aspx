                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-12 col-sm-12">
                            <div class="divstyle" id="playArea" style="float: left; height: 350px; min-width: 100%">
                                <div style="width: 100%; height: 100%" id="displayFiles"></div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-5 col-md-8 col-sm-8">
                            <div style="background-color: #263f75; float: left; height: 350px; color: #c7b427">
                            ...
                            <ContentTemplate>
                                <asp:GridView Width="80%" GridLines="Horizontal" BorderStyle="None"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkPlay" runat="server" Text="<%$Resources:Resource, play %>" CommandName="play"
