...
// login
function clickLogin(ip, p, id, pass, campro) {
    ...
    if (campro == 'Hik') {
        ...
        var iframe = document.getElementById("MainContent_frame1");
        iframe.contentWindow.LoginDevice(ip, id, pass);
    }
return false;
}
...
oWndInfo = WebVideoCtrl.I_GetWindowStatus(i);
if (oWndInfo == null) {
iWndIndex = i;
  break;
        }
