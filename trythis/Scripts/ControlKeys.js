$(function () {
    ...
    $.connection.hub.start({ waitForPageLoad: false }).done(function () {
        $(document).on("click", "#systempower", function () {
            ...
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 18 22");
        });
        $(document).on("click", "#syslock", function () {
            var src = document.getElementById('syslock');
            if (src.src =="Images/unlock.png")
                chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 2c 36");
            else
                chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 2d 37");
        });
        $(document).on("click", "#podiumlock", function () {
            var src = document.getElementById('podiumlock');
            if (src.src == "Images/unlock.png")
                chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 2e 38");
            else
                chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 2f 39");
        });
        $(document).on("click", "#classlock", function () {
            var src = document.getElementById('classlock');
            if (src.src == "Images/unlock.png")
                chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 5f 69");
            else
                chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 60 6A");
        });
        $(document).on("click", "#dsup", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 5f 6A");
        });
        $(document).on("click", "#dcopen", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 05 5f 6A");
        });
        ...
        $(document).on("click", "#desktop", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 10 1A");
        });
        $(document).on("click", "#laptop", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 11 1b");
        });
        $(document).on("click", "#platform", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 12 1c");
        });
        $(document).on("click", "#digitalEquipment", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 13 1d");
        });
        $(document).on("click", "#dvd", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 14 1e");
        });
        $(document).on("click", "#tv", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 15 1f");
        });
        $(document).on("click", "#bluray", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 1a 24");
        });
        $(document).on("click", "#camera", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 16 20");
        });
        $(document).on("click", "#recorder", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 19 23");
        });
        $(document).on("click", "#projectorOn", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 33 3d");
        });
        $(document).on("click", "#projectorOff", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 43 4d");
        });
        $(document).on("click", "#hdmi", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 34 3E");
        });
        $(document).on("click", "#projVideo", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 35 3f");
        });
        $(document).on("click", "#vga", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 44 4e");
        });
        $(document).on("click", "#volminus", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 21 2b");
        });
        $(document).on("click", "#volplus", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 20 2a");
        });
        $(document).on("click", "#mute", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 22 2c");
        });
        $(document).on("click", "#wiredvolplus", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 23 2d");
        });
        $(document).on("click", "#wiredmute", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 25 2f");
        });
        $(document).on("click", "#wiredvolminus", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 24 2e");
        });
        $(document).on("click", "#wirelessvolplus", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 73 7d");
        });
        $(document).on("click", "#wirelessvolminus", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 74 7e");
        });
        $(document).on("click", "#wirelessmute", function () {
            chat.server.sendControlKeys("192.168.1.26", "8B B9 00 04 02 04 75 7f");
        });
    });
});
