    ...
    <tr>  
        ...
        <td>
            ...
            <asp:TextBox ID="txtloc" runat="server" AutoPostBack="true" Width="70%"
                placeHolder="search" OnTextChanged="txtloc_TextChanged" /></td>
...
<asp:GridView ID="gvCard" runat="server" AutoGenerateColumns="false" 
    OnPageIndexChanging="gvCard_PageIndexChanging" 
     PageSize="2"  AllowPaging="true" class="display table table-bordered" 
     AutoGenerateDeleteButton="false" AutoGenerateEditButton="true"
     OnRowDeleting="gvCard_RowDeleting" OnRowCancelingEdit="gvCard_RowCancelingEdit"
    ...
    <asp:BoundField HeaderText="Pending Access(For)" SortExpression="pending"        
        ...
        <asp:TemplateField HeaderText="Change Location">
                          ...
                          <ControlStyle Width="100%" />
                          <ItemTemplate>
                              <asp:LinkButton ID="selectAccessTree" ToolTip="Click to change location access" runat="server" text="select" CssClass="linkcursor"
          ...
          <div class="modal "  id="modalAccess" style="max-height:600px; display:none; overflow-y:auto; position:center; margin-left:300px; margin-top:200px">
